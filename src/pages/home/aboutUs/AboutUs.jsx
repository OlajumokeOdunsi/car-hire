...
const AboutUs = () => {
  return (
    <div className="w-full xl:h-screen h-auto xl:px-[70px] px-[25px] flex xl:flex-row flex-col justify-between gap-[40px] pt-[680px] min-[320px]:pt-[600px] min-[375px]:pt-[650px] xl:pt-[230px] min-[360px]:pt-[650px]">
      <div className="flex-1">
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-1">
            ...
            <p className="min-[320px]:text-[14px] mb-2 text-[#000d6b]">Lorem ipsum dolor sit amet, adipisicing.</p>
          </div>
          <div className="flex items-center gap-1">
            <FaCheck className="pt-1 min-[320px]:pt-0 text-[#000d6b]" />
            <p className="min-[320px]:text-[14px] text-[#000d6b]">Lorem ipsum dolor sit, consectetur adipisicing.</p>
          </div>
        </div>
      </div>
      <div className="flex-1">
