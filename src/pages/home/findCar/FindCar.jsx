...
const FindCar = () => {
  ...
  return (
    <div
      ...
      className="w-[90%] xl:h-[35vh] h-auto m-auto p-[30px] shadow-md flex flex-col xl:flex-row items-center gap-[50px] absolute xl:top-[120%] min-[320px]:top-[105%] xl:left-[60px] top-[115%]  left-[20px] z-20 bg-white"
    >
      <div>
